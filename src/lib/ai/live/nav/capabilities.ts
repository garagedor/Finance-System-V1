...
export const NAV_CAPABILITIES: Record<string, Capability> = {
  ...
  "/portal/income": { allowedParams: ["from", "to", "source"] },
  "/portal/expenses": { allowedParams: ["from", "to", "category", "status", "vendor"] },
  "/portal/payouts": { allowedParams: ["status", "recipient", "tab"] },
  "/portal/reports": { allowedParams: ["type", "subject"] },
  ...
  "/portal/banking/reconcile": { allowedParams: ["from", "to"] },
