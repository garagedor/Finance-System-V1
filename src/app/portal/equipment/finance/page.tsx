...
export default async function EquipmentFinancePage({
  searchParams,
}: {
  ...
  return (
    <div className="portal-page">
      <PageHeader
        ...
        subtitle="Door / motor / parts purchases and manual sales — the free-form finance side."
        actions={
          <EntryFormModal
      ...
      <FilterBar>
        ...
        <Link href="/portal/equipment/finance" className="portal-btn">Clear</Link>
      </FilterBar>
